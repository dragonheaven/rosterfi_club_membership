                            ...
                            <tr>
                                <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                    ...
                                    <h1 style="<?php echo e($style['header-1']); ?>">
                                        Welcome <?php echo e(ucfirst($user->first_name)); ?>!
                                    </h1>

                                    <!-- Intro -->
                                    <p style="<?php echo e($style['paragraph']); ?>">Welcome to Rosterfi, please validate your email by following the link below:</p>

                                <!-- Action Button -->
                                    <table style="<?php echo e($style['body_action']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                <a href="<?php echo e(env('APP_URL')); ?>/validate/<?php echo e($user->id); ?>/<?php echo e($user->email_validation); ?>"
                                                   style="<?php echo e($fontFamily); ?> <?php echo e($style['button']); ?> <?php echo e($style['button--green']); ?>"
                                                   class="button"
                                                   target="_blank">
                                                    Validate Email
                                                </a>
                                    ...
                                    <table style="<?php echo e($style['body_sub']); ?>">
                                        <tr>
                                            <td style="<?php echo e($fontFamily); ?>">
                                                ...
                                                <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                    <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(env('APP_URL')); ?>/validate/<?php echo e($user->id); ?>/<?php echo e($user->email_validation); ?>" target="_blank">
                                                        <?php echo e(env('APP_URL')); ?>/validate/<?php echo e($user->id); ?>/<?php echo e($user->email_validation); ?>
